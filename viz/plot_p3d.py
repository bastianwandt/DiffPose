# Code from: https://github.com/twehrbein/Probabilistic-Monocular-3D-Human-Pose-Estimation-with-Normalizing-Flows/blob/main/viz/plot_p3d.py
...
def plot17j(pose, swap_axes=True, return_fig=False):
