# Code from: https://github.com/twehrbein/Probabilistic-Monocular-3D-Human-Pose-Estimation-with-Normalizing-Flows/blob/main/config.py
import torch
import argparse
...
experiment_name = exp  # name of the experiment (log files saved in folder with this name)
...
COND_JOINTS = 16  # number of heatmap fits per img, including hip joints
